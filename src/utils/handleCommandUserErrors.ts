export const handleCommandUserErrors = (errorIdentifier: string) => {
	switch (errorIdentifier) {
		...
		case 'argsMissing': {
			return 'Nie podałeś argumentów! Jako pierwszy arugment oznacz użytkownika, któremu dziękujesz, a jako drugi argument jeżeli chcesz, wiadomość za co mu dziekujesz.';
		}
		default: {
